var renderer, scene, camera, camera2, robot, brazo, antebrazo, mano, angulo = 0;
...
function render() {
    ...
    // Render the scene from the second camera's perspective in a small viewport
    ...
    // Reset the viewport and scissor test after rendering with camera2
    renderer.setViewport(0, 0, window.innerWidth, window.innerHeight);
    renderer.setScissor(0, 0, window.innerWidth, window.innerHeight);
